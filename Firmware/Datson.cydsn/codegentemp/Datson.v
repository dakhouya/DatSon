// ======================================================================
// Datson.v generated from TopDesign.cysch
// 11/29/2015 at 00:38
...
// CharLCD_v2_10(ConversionRoutines=true, CUSTOM0="4,6,15,E,E,15,6,4,", CUSTOM1="0,A,A,4,4,4,0,0,", CUSTOM2="0,E,A,E,8,8,0,0,", CUSTOM3="0,E,A,C,A,A,0,0,", CUSTOM4="0,E,8,C,8,E,0,0,", CUSTOM5="0,E,8,E,2,E,0,0,", CUSTOM6="0,E,8,E,2,E,0,0,", CUSTOM7="0,4,4,4,0,4,0,0,", CustomCharacterSet=3, TypeReplacementString=uint32, CY_COMPONENT_NAME=CharLCD_v2_10, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=LCD, CY_INSTANCE_SHORT_NAME=LCD, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=10, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.2 SP1, INSTANCE_NAME=LCD, )
module CharLCD_v2_10_0 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("90fa3859-49ac-4a44-812e-dd944f5cdbd4/ed092b9b-d398-4703-be89-cebf998501f6"),
...
module BLE_v2_10_3 (
	...
	cy_clock_v1_0
		#(.id("08fc8274-4b92-4f49-bb62-583b89881335/5ae6fa4d-f41a-4a35-8821-7ce70389cb0c"),
...
module top ;
	...
	cy_clock_v1_0
		#(.id("c280d692-e81f-4eb0-97fd-705e9aeda8e0"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("20000000000"),
		  .is_direct(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("c0c0ce78-68f2-45ae-a4a4-c961cd4f7472"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("34b06285-64b4-49ea-a2a3-fd74f18ef849"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
