...
#define CYBLE_SERIAL_PORT_SERVICE_INDEX   (0x00u) /* Index of Serial Port service in the cyBle_customs array */
#define CYBLE_SERIAL_PORT_RX_CHAR_INDEX   (0x00u) /* Index of Rx characteristic */
#define CYBLE_SERIAL_PORT_TX_CHAR_INDEX   (0x01u) /* Index of Tx characteristic */
#define CYBLE_SERIAL_PORT_TX_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_INDEX   (0x00u) /* Index of Client Characteristic Configuration descriptor */


#define CYBLE_SERIAL_PORT_SERVICE_HANDLE   (0x000Cu) /* Handle of Serial Port service */
#define CYBLE_SERIAL_PORT_RX_CHAR_HANDLE   (0x000Eu) /* Handle of Rx characteristic */
#define CYBLE_SERIAL_PORT_TX_CHAR_HANDLE   (0x0010u) /* Handle of Tx characteristic */
#define CYBLE_SERIAL_PORT_TX_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_HANDLE   (0x0011u) /* Handle of Client Characteristic Configuration descriptor */
